/* shocker: docker PoC VMM-container breakout originally by (C) 2014 Sebastian Krahmer
 *
 * THIS VERSION READS A FILE and WORKS with gcc dac_override.c -o write
 * ./write /whatever/in_the_host /file_that_you_want_to_copy_to_the_host
